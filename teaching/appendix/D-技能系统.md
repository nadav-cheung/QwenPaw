...
安全扫描在技能创建/导入/启用操作时自动触发，详细机制见 [35-安全架构](../level-5-model-security/35-安全架构.md)。
...
- 想开发自己的技能？查看 [22-技能系统](../level-3-agent-core/22-技能系统.md)
- 想了解技能的内部实现？查看 [18-智能体架构](../level-3-agent-core/18-智能体架构.md)
...
**练习 4：**
参考 `22-技能系统.md` 创建 SKILL.md 和 Python 脚本。
...
| 方向 | 章节 | 说明 |
|------|------|------|
| 技能开发 | [22-技能系统](../level-3-agent-core/22-技能系统.md) | 学习如何开发自定义技能 |
| 智能体核心 | [18-智能体架构](../level-3-agent-core/18-智能体架构.md) | 理解技能如何被 Agent 加载和调用 |
| 安全机制 | [35-安全架构](../level-5-model-security/35-安全架构.md) | 深入了解技能安全扫描 |
